#' Decodifica a variavel de raca/cor no formato SINAN
#'
#' @description
#' A funcao \code{ds_raca_sinan()} converte os codigos numericos da variavel \code{cd_raca}
#' em descricoes padronizadas conforme o formato utilizado nos dados do SINAN.
#'
